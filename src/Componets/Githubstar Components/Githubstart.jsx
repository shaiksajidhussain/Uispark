...
const Githubstart = () => {
  ...
  return (
    <>
      <div
        className=" bg-dark-800 min-h-[200px] py-8 bg-dark-800 px-14 content-center w-full flex sm:justify-between gap-6 flex-wrap items-center relative overflow-hidden rounded-3xl"
        bis_skin_checked={1}
        data-aos="zoom-in-up">
        <div
          className="flex gap-5 items-center flex-wrap relative z-10 text-white"
          bis_skin_checked={1}
        ...
        >
            <svg
                ...
                width={24}
                height={24}
                className="h-16 w-16 transform transition-transform duration-500 hover:scale-125 "
            >
          ...
          <div bis_skin_checked={1}>
            ...
            <a
              className=" text-sm font-mono text-[#3399FF]"
              style={glowStyle}
              href="https://uispark.vercel.app/"
              target="_blank"
            >
              uispark
            </a>
