...
const Afterhero = () => {
    ...
    return (
        <>
            ...
            <section className="bg-[#121920] text-white p-10 xl:mx-28 xl:w-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 ">
                        <div className="bg-gradient-to-b from-gray-800 to-gray-900 p-6 rounded-lg shadow-lg">
                            <div className="flex items-center justify-center mb-4">
                                <span className="text-[#3399FF] text-2xl" style={glowStyle}>💧</span>
                            </div>
                        ...
                        <div className="bg-gradient-to-b from-gray-800 to-gray-900 p-6 rounded-lg shadow-lg">
                            <div className="flex items-center justify-center mb-4">
                                <span className="text-[#3399FF] text-2xl " style={glowStyle}>🛠️</span>
                            </div>
                        ...
                        <div className="bg-gradient-to-b from-gray-800 to-gray-900 p-6 rounded-lg shadow-lg">
                          ...
                          <div className="bg-gradient-to-b from-gray-800 to-gray-900 p-6 rounded-lg shadow-lg">
                    <div className="flex items-center justify-center mb-4">
                        <span className="text-blue-400 text-2xl" style={glowStyle}>📄</span>
                    </div>
